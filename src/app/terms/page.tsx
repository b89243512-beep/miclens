...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Terms of use for MicLens, the free browser-based document scanner with OCR.",
    ...
    <>
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-[var(--muted)] mb-4">
          By using MicLens you agree to these terms. If you do not agree, please do not use the service.
        </p>

        <h2 className="text-xl font-bold mt-8 mb-3">The service</h2>
        <p className="text-[var(--muted)] mb-4">
          MicLens is a browser-based document scanner and OCR tool offered free of charge. The service is provided as is,
        ...
        <ul className="text-[var(--muted)] space-y-2 mb-4">
          <li>• You agree not to use MicLens for unlawful purposes or to violate the rights of others.</li>
        ...
        <p className="text-[var(--muted)] mb-4">
          MicLens is an independent product. We are not affiliated with, endorsed by, or sponsored by Microsoft or any
        ...
        <p className="text-[var(--muted)] mb-4">
          The MicLens name, logo, and site design belong to us. The OCR engine is open source and used under its own
          license. Text you scan belongs to you.
        </p>

        <h2 className="text-xl font-bold mt-8 mb-3">Liability</h2>
        <p className="text-[var(--muted)] mb-4">
          To the extent permitted by law, MicLens is not liable for any indirect or consequential damages arising from
